...
class ColorMap:
    def __init__(self):
        self.colormap_path = "/mnt/d/junch_data/AtlasNet/AtlasNet_MY/dataset/colormap.npy"
...
def save(mesh, path, colormap):
    ...
    #pymesh.save_mesh("/mnt/d/junch_data/AtlasNet/AtlasNet_MY/model/ee.ply", mesh, *mesh.get_attribute_names(), ascii=True)